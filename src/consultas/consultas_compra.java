...
public class consultas_compra extends conexion {
	...
	public boolean insertarEliminacion(compra compra) {
		...
		String sql = "INSERT INTO compras (id_compra, nombre_objeto_compra, precio_objeto_compra, descripcion_objeto_compra, peso_objeto_compra, color_objeto_compra, marca_objeto_compra, modelo_objeto_compra, cantidad_objeto_compra, fecha_registro_compra ) VALUES(?,?,?,?,?,?,?,?,?,?)";
