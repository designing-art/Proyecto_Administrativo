...
public class consultas_factura_cliente extends conexion {
	...
	public boolean insertarEliminacion(factura_cliente factura_cliente) {
		PreparedStatement ps = null;
		Connection con = getConexion();

		String sql = "INSERT INTO facturas_clientes (id_facturas_cliente, numero_factura_cliente, fecha_hora_factura_cliente, firma_cliente, rtn_factura_cliente, direccion_cliente, por_concepto_cliente, cantidad_letras_cliente, cantidad_pagada_cliente, empleado_atencion_cliente) VALUES(?,?,?,?,?,?,?,?,?,?)";
