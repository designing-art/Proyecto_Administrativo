...
public class consultas_historial_planilla extends conexion {
	...
	public boolean registrarEliminacion(historial_planilla historial_planilla) {
		...
		String sql = "INSERT INTO historial_planillas (id_planilla_final, tipo_planilla_final, fecha_crecion_planilla_final, fecha_pago_planilla_final, nombre_planilla_final, total_deducciones_planilla_final, total_bonificaciones_planilla_final, total_sueldos_planilla_final, total_pago_planilla_final, estado_planilla) VALUES(?,?,?,?,?,?,?,?,?,?)";
