...
public class consultas_producto extends conexion {
	...
	public boolean insertar(producto producto) {
		...
		String sql = "INSERT INTO productos (dispositivo_de_entrega_producto, marca_producto, capacidad_produto, color_producto, precio_producto, direccion_foto_producto ) VALUES(?,?,?,?,?,?)";
	...
	public boolean actualizar(producto producto) {
		...
		String sql = "UPDATE productos SET id_producto=?, dispositivo_de_entrega_producto=?, marca_producto=?, capacidad_produto=?, color_producto=?, precio_producto=?, direccion_foto_producto=? WHERE id_producto=? ";
