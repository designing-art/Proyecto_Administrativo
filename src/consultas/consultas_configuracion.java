...
public class consultas_configuracion extends conexion {
	...
	public boolean insertar(configuracion configuracion) {
		...
		String sql = "INSERT INTO configuraciones (sonido_configuracion, tema_configuracion) VALUES(?,?)";
	...
	public boolean actualizar(configuracion configuracion) {
		...
		String sql = "UPDATE configuraciones SET id_configuracion=?, sonido_configuracion=?, tema_configuracion=? WHERE id_configuracion=? ";
