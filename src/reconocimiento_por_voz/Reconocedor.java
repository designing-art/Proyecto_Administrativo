...
public class Reconocedor extends JFrame implements ActionListener{
	...
	public Reconocedor() {
		...
		Inicio();
		Image microImage = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/iconos/microfono.jpg"));
	...
	public void iniciarRec() {
		...
		JOptionPane.showMessageDialog(null, "Pronuncie Aplicacion a Ejecutar");
			...
			oreja.allocate();
			FileReader grammar1 =new FileReader("C:\\Users\\hp\\Documents\\GitHub\\Proyecto_Administrativo\\librerias\\diccionario.txt"); //ruta donde esta el archivo con las Frases
