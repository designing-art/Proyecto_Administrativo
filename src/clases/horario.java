...
public class horario {
	...
	public String getHoras_horario() {
		return horas_horario;
	}
	public void setHoras_horario(String horas_horario) {
		this.horas_horario = horas_horario;
	}
